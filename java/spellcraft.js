...
var LetterGrid =
{
    ...
    init: function()
	{
        ...
        LetterGrid.Grid = new Array(LetterGrid.Columns);
        
        // Build grid
        for(var x = 0; x < LetterGrid.Columns; x++)
		{
            LetterGrid.Grid[x] = new Array(LetterGrid.Rows);
    ...
    shift: function(origin, direction, offset)
    {
        ...
        case 'Horizontal':
            if(offset > 0)
            {
                ...
                for (var i = LetterGrid.Columns - 1; i >= 0; i--)
                    if(i == 0)
                ...
                for (var i = 0; i < LetterGrid.Columns; i++)
        ...
        case 'Vertical':
            if(offset > 0)
            {
                ...
                for (var i = LetterGrid.Rows - 1; i >= 0; i--)
                    if(i == 0)
                ...
                for (var i = 0; i < LetterGrid.Rows; i++)
    ...
    {
        $('#stats').html('');
        for (i in LetterGrid.Words)
        {
            $('#stats').append('<div>' + LetterGrid.Words[i] + ' is' + (Dictionary.lookUp(LetterGrid.Words[i]) ? '' : ' NOT') + ' a valid word.</div>');
        }
    }
}
